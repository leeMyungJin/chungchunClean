...
export class DataTransfer {
    ...
    set dropEffect(value) {
        this._dropEffect = core.asString(value);
    }
    /**
    ...
    set effectAllowed(value) {
        this._effectAllowed = core.asString(value);
    }
    /**
    ...
    setDragImage(img, offsetX, offsetY) {
        ...
        ddt._imgCustom = img;
        ddt._imgOffset = new core.Point(offsetX, offsetY);
    }
}
/**
...
export class DragDropTouch {
    ...
    constructor() {
        ...
        core.assert(!DragDropTouch._instance, 'DragDropTouch instance already created.');
    ...
    _touchstart(e) {
        if (this._shouldHandle(e)) {
            ...
            var src = core.closest(e.target, '[draggable]');
            if (src) {
    ...
    _getPoint(e, page) {
        ...
        core.assert(e && ('clientX' in e), 'invalid event?');
        if (page == true) {
            return new core.Point(e.pageX, e.pageY);
        }
        else {
            return new core.Point(e.clientX, e.clientY);
        }
    }
    ...
    _createImage(e) {
        ...
        if (!this._imgCustom) {
            ...
            this._imgOffset = new core.Point(pt.x - rc.left, pt.y - rc.top);
