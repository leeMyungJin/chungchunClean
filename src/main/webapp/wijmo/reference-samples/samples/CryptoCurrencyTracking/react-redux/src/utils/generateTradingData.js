import { default as randBetween } from './randBetween';
export default function generateTradingData(symbols, tickers, trading = [], histLength = 60) {
    ...
    return symbols.map(symbol => {
        ...
        return Object.assign({}, entry, { history: [entry, ...history] });
    });
}
