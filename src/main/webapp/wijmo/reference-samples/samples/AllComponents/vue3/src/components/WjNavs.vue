<template>
    <div>
        ...
        <p>
            This section shows TreeView Control.
        </p>
        <div class="seperator" />
        <wj-tree-view
                :items-source="items"
                ...
                :selected-item-changed="selectedChanged"/>
        <p/>
        <div class="app-input-group">
            <b>Selected Item: {{selectedItem ? selectedItem.header : ''}}</b>
        </div>
        ...
        <p>
          This section shows TabPanel Control.
        </p>
        ...
        <p>
          This section shows Accordion Control.
        </p>
        <wj-accordion
                :showIcons="showIcons"
...
export default {
    data: function () {
        var data = DataService.getTreeData();
        return {
            items: data,
            selectedItem: data[0]    ,
            showIcons: true,
