...
import { _BarPlotter, _DataInfo, _DataPoint, IRenderEngine, _IAxis, _ISeries, _IPalette, SeriesBase, Stacking, _LinePlotter, ChartType, FlexChartCore, _IPlotter, Axis, AxisType } from 'wijmo/wijmo.chart';
/**
