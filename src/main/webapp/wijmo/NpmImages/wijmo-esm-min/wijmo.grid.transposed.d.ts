...
import { MergeManager, GridPanel, CellRange, FlexGrid, Column, ColumnCollection, CellRangeEventArgs, AllowSorting, _ColumnGroupHandler, ColumnGroup } from 'wijmo/wijmo.grid';
 ...
 */
export declare class _RowGroupHandler extends _ColumnGroupHandler {
    /**
 ...
 */
export declare class _RowGroup extends ColumnGroup {
    private _height;
    /**
