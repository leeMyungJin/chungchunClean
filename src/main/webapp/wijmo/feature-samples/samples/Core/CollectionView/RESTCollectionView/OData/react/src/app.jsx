...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <FlexGrid isReadOnly={true} showMarquee={true} selectionMode='MultiRange' deferResizing={true} alternatingRowStep={0} itemsSource={this.state.view} initialized={s => s.topLeftCells.columns[0].cellTemplate = ($) => $.text || ($.row.index + 1).toString()}>
                <FlexGridFilter />
            </FlexGrid>
        </div>;
    }
