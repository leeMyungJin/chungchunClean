...
//
import { Component, enableProdMode, NgModule, ViewChild, OnInit, Inject } from '@angular/core';
...
export class AppComponent implements OnInit {
    ...
    @ViewChild('theCalendar', { static: true }) theCalendar: input.Calendar;
    //
