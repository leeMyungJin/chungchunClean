    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <wj-combo-box
                ...
                :itemsSource="objects"
                :initialized="initComboObject">
            </wj-combo-box>
        </div>
        <p>
            The current value is:
            <b v-if="theComboObject.selectedValue">
                {{ theComboObject.selectedValue.country }} 
                (sales: {{ theComboObject.selectedValue.sales | formatCurrency }}, 
                expenses {{ theComboObject.selectedValue.expenses | formatCurrency }})
            </b>
        </p>
    </div>
</template>
