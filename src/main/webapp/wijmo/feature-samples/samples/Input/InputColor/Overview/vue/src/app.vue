<template>
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <wj-input-color id="theInputColor"
        ...
        <p>
            You can customize the InputColor using the <b>colorPicker</b> property,
            which exposes the color picker drop-down:
        </p>
        ...
        <div class="form-group">
            ...
            <wj-combo-box id="thePalette"
                :itemsSource="palettes"
                :displayMemberPath="'name'"
                :selectedIndexChanged="changePalette" />
        </div>

        <div class="form-group">
            <label for="theInputColorCst">Custom:</label>
            <wj-input-color id="theInputColorCst"
                :value="background"
                :initialized="initColor"
                :valueChanged="onValueChanged" />
        </div>
    </div>
</template>
