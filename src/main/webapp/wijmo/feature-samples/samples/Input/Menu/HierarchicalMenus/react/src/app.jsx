    ...
    render() {
        return <div className="container-fluid">
            <div className="menubar">
                <Menu id="fileMenu" header="File" displayMemberPath="header" subItemsPath="items" showDropDownButton={false} openOnHover={this.state.openOnHover} isAnimated={this.state.isAnimated} itemsSource={this._menuTree.fileMenu} itemClicked={this._menuItemClicked.bind(this)}/>
                <Menu id="editMenu" header="Edit" displayMemberPath="header" subItemsPath="items" showDropDownButton={false} openOnHover={this.state.openOnHover} isAnimated={this.state.isAnimated} itemsSource={this._menuTree.editMenu} itemClicked={this._menuItemClicked.bind(this)}/>
                <Menu id="formatMenu" header="Format" displayMemberPath="header" subItemsPath="items" openOnHover={this.state.openOnHover} isAnimated={this.state.isAnimated} itemsSource={this._menuTree.formatMenu} initialized={this._initFormatMenu.bind(this)}/>
            </div>
    ...
    _initFormatMenu(sender) {
        sender.command = {
            executeCommand: (param) => {
                ...
                let cssStyle = getComputedStyle(this._menuTarget, null);
                switch (param.prop) {
                    case 'face':
