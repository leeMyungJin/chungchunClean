...
export class AppComponent implements OnInit {
    @ViewChild('menuTarget', { static: true }) private _menuTarget: ElementRef; // element used to show menu commands
    @ViewChild('fileMenu', { static: true }) private _fileMenu: input.Menu;
    @ViewChild('editMenu', { static: true }) private _editMenu: input.Menu;
    @ViewChild('formatMenu', { static: true }) private _formatMenu: input.Menu;
    private _rtl = false;
    //
    menuTree: TMenuTree;
    isAnimated = true;
