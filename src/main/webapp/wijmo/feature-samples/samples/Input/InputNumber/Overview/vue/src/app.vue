<template>
    <div class="container-fluid">
        ...
        <div class="form-group">
            <label for="theNumber">InputNumber</label>
            <wj-input-number v-model="theValue" id="theNumber" ></wj-input-number>
        </div>
        <div>
            The current value is <b>{{ theValue }}</b>.
        </div>
        ...
        <div class="form-group">
            <label for="theNumberNotRequired">Not Required</label>
            <wj-input-number 
                id="theNumberNotRequired" 
                :isRequired=false 
                :value=null 
                placeholder="Your age (optional)"></wj-input-number>
        </div>
    </div>
</template>
