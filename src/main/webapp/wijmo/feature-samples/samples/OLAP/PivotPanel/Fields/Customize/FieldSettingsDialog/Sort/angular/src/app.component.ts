...
export class AppComponent {
    @ViewChild('theGrid', { static: true }) pivotGrid: wjOlap.PivotGrid;
    @ViewChild('sortSales', { static: true }) sortSales: wjInput.ComboBox;
    @ViewChild('sortExpenses', { static: true }) sortExpenses: wjInput.ComboBox;
