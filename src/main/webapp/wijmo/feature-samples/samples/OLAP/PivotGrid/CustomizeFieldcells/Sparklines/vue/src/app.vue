<template>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-7">
                <wj-pivot-grid :itemsSource="ng" :isReadOnly=true :formatItem="formatItem"></wj-pivot-grid>
            </div>
        </div>
    </div>
</template>
            ...
            formatItem(s, e) {
                ...
                if (e.panel == s.cells && ng.valueFields.length) {
                    ...
                    let field = ng.valueFields[e.col % ng.valueFields.length],
                        ...
                        spark = field.header.match(/Sparklines|Sparkbars/) != null;
                    ...
                    if (spark) {
                        ...
                        if (!item.sparkData) {
                            e.cell.innerHTML = '';
                            setTimeout(() => {
                                let detail = ng.getDetail(item, binding),
                                    len = detail.length;
