    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <label>
                Country:
                <wj-combo-box
                    :items-source="sortOptions"
                    :selectedIndexChanged="onCountrySelectedIndexChanged" />
            </label>
            <label>
                Product:
                <wj-combo-box
                    :items-source="sortOptions"
                    :selectedIndexChanged="onProductSelectedIndexChanged" />
            </label>
            <h4>
                Sort Measure fields
            </h4>
            <label>
                Sales:
                <wj-combo-box
                    :items-source="sortOptions2"
                    :initialized="initializeSortSales"
            ...
            <label>
                ...
                <wj-combo-box
                    :items-source="sortOptions2"
                    :initialized="initializeSortExpenses"
                    :selectedIndexChanged="updateMeasureSort" />
            </label>
            <label>
                Subtotals:
                <input id="subtotals" type="checkbox" v-on:click="onSubtotalsClick" />
            </label>
            </div>
            <div class="col-xs-8">
                <wj-pivot-grid
                    :items-source="ng"
                    :initialized="initializePivotGrid" />
            </div>
        </div>
    </div>
</template>
...
let App = Vue.extend({
    ...
    methods: {
        ...
        updateMeasureSort() {
            if (this.sortSales && this.sortExpenses) {
