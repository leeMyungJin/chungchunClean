    ...
    render() {
        return (<div className="container-fluid">
                <div id="buttons" className="buttons" onClick={this.onButtonClick.bind(this)}>
                    <button id="who" className="btn btn-success">
                        How much was spent by each person?
                    </button>
                    <button id="what" className="btn btn-success">
                        How much was spent on each expense type?
                    </button>
                    <button id="who-what" className="btn btn-success">
                        What did each person spend money on?
                    </button>
                    <button id="when" className="btn btn-success">
