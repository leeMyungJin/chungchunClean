...
export class AppComponent {
    ...
    constructor(@Inject(DataService) dataSvc: DataService) {
        this._data = dataSvc.getEmployeesWithExpences();
    }

    saveExpenses() {
        let workbook = this._exportExpenseReport(this._data);
        workbook.saveAsync('ExpenseReport.xlsx');
    }

    private _exportExpenseReport(employees: any[]): wjcXlsx.Workbook {
