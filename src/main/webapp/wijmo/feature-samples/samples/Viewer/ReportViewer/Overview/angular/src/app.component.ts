...
export class AppComponent {
    @ViewChild('reportViewer', { static: true }) reportViewer: viewer.ReportViewer;
    //
    get continuousViewMode(): boolean {
        return this.reportViewer.viewMode === viewer.ViewMode.Continuous;
    }
    set continuousViewMode(value: boolean) {
        this.reportViewer.viewMode = value ? viewer.ViewMode.Continuous : viewer.ViewMode.Single;
    }
}
//
@NgModule({
