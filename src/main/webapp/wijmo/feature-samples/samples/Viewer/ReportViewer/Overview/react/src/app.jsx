    ...
    render() {
        return <div className="container-fluid">
            ...
            <div className="col-md-12">
                <div className="row">
                    <wjViewer.ReportViewer filePath="ReportsRoot/Formatting/AlternateBackground.flxr" reportName="AlternateBackground" viewMode={this.state.viewMode} mouseMode={this.state.mouseMode} fullScreen={this.state.fullScreen} zoomFactor={this.state.zoomFactor} viewModeChanged={this.viewModeChanged.bind(this)} fullScreenChanged={this.fullScreenChanged.bind(this)} zoomFactorChanged={this.zoomFactorChanged.bind(this)} serviceUrl="https://demos.componentone.com/ASPNET/c1webapi/4.5.20193.222/api/report">
                ...
                <div className="row">
                    <div className="form-horizontal">
                        <div className="form-group">
                            ...
                            <div className="col-md-3">
                                <wjInput.Menu header='Mouse mode' value={this.state.mouseMode} itemClicked={this.mouseModeChanged.bind(this)}>
