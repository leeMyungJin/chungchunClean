<template>
    <div class="container-fluid">
        ...
        <wj-flex-sheet :initialized="initializeFlexSheet">
            <wj-sheet :name="'Basic Operators'" :rowCount="35" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Math'" :rowCount="90" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Logical'" :rowCount="30" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Text'" :rowCount="80" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Aggregate'" :rowCount="170" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Date'" :rowCount="60" :columnCount="9"></wj-sheet>
            <wj-sheet :name="'Lookup & Reference'" :rowCount="55" :columnCount="10"></wj-sheet>
            <wj-sheet :name="'Financial'" :rowCount="20" :columnCount="8"></wj-sheet>
            <wj-sheet :name="'Summary'" :rowCount="20" :columnCount="8"></wj-sheet>
        </wj-flex-sheet>
        <p>
            <b>Cell Content:</b>
            {{currentCellData}}
...
let App = Vue.extend({
    ...
    methods: {
        initializeFlexSheet: function(flex) {
            flex.deferUpdate(() => {
                for (let i = 0; i < flex.sheets.length; i++) {
                    ...
                    switch (flex.sheets[i].name) {
                        case "Basic Operators":
                            ...
                            break;
                        case "Math":
                            this._generateMathSheet(flex);
                            break;
                        case "Logical":
                            this._generateLogicalSheet(flex);
                            break;
                        case "Text":
                            this._generateTextSheet(flex);
                            break;
                        case "Aggregate":
                            this._generateAggregateSheet(flex);
                            break;
                        case "Date":
                            this._generateDateSheet(flex);
                            break;
                        case "Lookup & Reference":
                            this._generateLookupReferenceSheet(flex);
                            break;
                        case "Financial":
                            this._generateFinancialSheet(flex);
                            break;
                        case "Summary":
                            this._generateSummraySheet(flex);
                            break;
                    }
                }
            ...
            flex.selectionChanged.addHandler((sender, args) => {
                ...
                if (selection.isValid) {
                    this.currentCellData = flex.getCellData(
                        selection.row,
                        selection.col,
                        true
                    );
        ...
        _generateBasicOperatorsSheet: function(flexSheet) {
            ...
            flexSheet.setCellData(
                19,
                1,
                "Indicates calculation priority by the bracket."
            );
            ...
            flexSheet.setCellData(
                24,
                1,
                "Parse the percentage to float number."
            );
            ...
            flexSheet.setCellData(
                28,
                1,
                "Parse the scientific number to float number."
            );
            ...
            flexSheet.setCellData(
                32,
                1,
                "Joins two text items into one text item."
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(0, 1, 0, 2),
                    new wjcGrid.CellRange(4, 1, 4, 2),
                    new wjcGrid.CellRange(9, 1, 9, 2),
                    new wjcGrid.CellRange(14, 1, 14, 2),
                    new wjcGrid.CellRange(18, 1, 18, 2),
                    new wjcGrid.CellRange(23, 1, 23, 2),
                    new wjcGrid.CellRange(27, 1, 27, 2),
                    new wjcGrid.CellRange(31, 1, 31, 2)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(2, 1, 2, 1),
                    new wjcGrid.CellRange(2, 3, 2, 3),
                    new wjcGrid.CellRange(6, 1, 7, 1),
                    new wjcGrid.CellRange(6, 3, 7, 3),
                    new wjcGrid.CellRange(11, 1, 12, 1),
                    new wjcGrid.CellRange(11, 3, 12, 3),
                    new wjcGrid.CellRange(16, 1, 16, 1),
                    new wjcGrid.CellRange(16, 3, 16, 3),
                    new wjcGrid.CellRange(20, 1, 21, 1),
                    new wjcGrid.CellRange(25, 1, 25, 1),
                    new wjcGrid.CellRange(25, 3, 25, 3),
                    new wjcGrid.CellRange(29, 1, 29, 1),
                    new wjcGrid.CellRange(29, 3, 29, 3),
                    new wjcGrid.CellRange(33, 1, 33, 1),
                    new wjcGrid.CellRange(33, 3, 33, 3)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(0, 1, 0, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(4, 1, 4, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 1, 9, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(10, 1, 10, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(14, 1, 14, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(15, 1, 15, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(19, 1, 19, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(20, 2, 20, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(23, 1, 23, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(24, 1, 24, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(27, 1, 27, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(28, 1, 28, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(31, 1, 31, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(32, 1, 32, 3));
        },

        _generateMathSheet: function(flexSheet) {
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(0, 1, 0, 1),
                    new wjcGrid.CellRange(4, 1, 4, 1),
                    new wjcGrid.CellRange(8, 1, 8, 1),
                    new wjcGrid.CellRange(12, 1, 12, 1),
                    new wjcGrid.CellRange(16, 1, 16, 1),
                    new wjcGrid.CellRange(20, 1, 20, 1),
                    new wjcGrid.CellRange(24, 1, 24, 1),
                    new wjcGrid.CellRange(28, 1, 28, 1),
                    new wjcGrid.CellRange(32, 1, 32, 1),
                    new wjcGrid.CellRange(36, 1, 36, 1),
                    new wjcGrid.CellRange(40, 1, 40, 1),
                    new wjcGrid.CellRange(44, 1, 44, 1),
                    new wjcGrid.CellRange(48, 1, 48, 1),
                    ...
                    new wjcGrid.CellRange(78, 1, 78, 1),
                    new wjcGrid.CellRange(83, 1, 83, 1)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(2, 1, 2, 1),
                    new wjcGrid.CellRange(2, 3, 2, 3),
                    new wjcGrid.CellRange(6, 1, 6, 1),
                    new wjcGrid.CellRange(6, 3, 6, 3),
                    new wjcGrid.CellRange(10, 1, 10, 1),
                    new wjcGrid.CellRange(10, 3, 10, 3),
                    new wjcGrid.CellRange(14, 1, 14, 1),
                    new wjcGrid.CellRange(14, 3, 14, 3),
                    new wjcGrid.CellRange(18, 1, 18, 1),
                    new wjcGrid.CellRange(18, 3, 18, 3),
                    new wjcGrid.CellRange(22, 1, 22, 1),
                    new wjcGrid.CellRange(22, 3, 22, 3),
                    new wjcGrid.CellRange(26, 1, 26, 1),
                    new wjcGrid.CellRange(26, 3, 26, 3),
                    new wjcGrid.CellRange(30, 1, 30, 1),
                    new wjcGrid.CellRange(30, 3, 30, 3),
                    new wjcGrid.CellRange(34, 1, 34, 1),
                    new wjcGrid.CellRange(34, 3, 34, 3),
                    new wjcGrid.CellRange(38, 1, 38, 1),
                    new wjcGrid.CellRange(38, 3, 38, 3),
                    new wjcGrid.CellRange(42, 1, 42, 1),
                    new wjcGrid.CellRange(42, 3, 42, 3),
                    new wjcGrid.CellRange(46, 1, 47, 1),
                    new wjcGrid.CellRange(46, 3, 47, 3),
                    new wjcGrid.CellRange(50, 1, 51, 1),
                    new wjcGrid.CellRange(50, 3, 51, 3),
                    new wjcGrid.CellRange(55, 1, 55, 1),
                    new wjcGrid.CellRange(55, 3, 55, 3),
                    new wjcGrid.CellRange(59, 1, 59, 1),
                    new wjcGrid.CellRange(59, 3, 59, 3),
                    new wjcGrid.CellRange(63, 1, 63, 1),
                    new wjcGrid.CellRange(63, 3, 63, 3),
                    new wjcGrid.CellRange(67, 1, 67, 1),
                    new wjcGrid.CellRange(67, 3, 67, 3),
                    new wjcGrid.CellRange(71, 1, 71, 1),
                    new wjcGrid.CellRange(71, 3, 71, 3),
                    new wjcGrid.CellRange(75, 1, 76, 1),
                    new wjcGrid.CellRange(80, 1, 81, 1),
                    new wjcGrid.CellRange(85, 1, 85, 1),
                    new wjcGrid.CellRange(85, 3, 85, 3)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 1, 9, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(13, 1, 13, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(17, 1, 17, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(21, 1, 21, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(25, 1, 25, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(29, 1, 29, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(33, 1, 33, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(37, 1, 37, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(41, 1, 41, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(45, 1, 45, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(49, 1, 49, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(54, 1, 54, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(58, 1, 58, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(62, 1, 62, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(66, 1, 66, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(70, 1, 70, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(73, 1, 73, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(74, 1, 74, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(75, 2, 75, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(79, 1, 79, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(80, 2, 80, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(84, 1, 84, 2));
        },

        _generateLogicalSheet: function(flexSheet) {
            flexSheet.setCellData(0, 1, "1. Compare operators");
            flexSheet.setCellData(
                1,
                1,
                "Gets boolean result of the compare operators such as (>, <, >=, <=, =, <>)."
            );
            flexSheet.setCellData(2, 1, "Sample:");
            ...
            flexSheet.setCellData(
                26,
                2,
                'if(true(), "true result", "false result")'
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(22, 1, 22, 1),
                    new wjcGrid.CellRange(22, 3, 22, 3),
                    new wjcGrid.CellRange(26, 1, 27, 1)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(0, 1, 0, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 1, 9, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(13, 1, 13, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(17, 1, 17, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(21, 1, 21, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(25, 1, 25, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(26, 2, 26, 4));
        },

        _generateTextSheet: function(flexSheet) {
            ...
            flexSheet.setCellData(
                63,
                2,
                'substitute("abcabcdabcdef","ab","xy")'
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(4, 1, 4, 1),
                    new wjcGrid.CellRange(8, 1, 8, 1),
                    new wjcGrid.CellRange(13, 1, 13, 1),
                    new wjcGrid.CellRange(17, 1, 17, 1),
                    new wjcGrid.CellRange(21, 1, 21, 1),
                    new wjcGrid.CellRange(26, 1, 26, 1),
                    new wjcGrid.CellRange(30, 1, 30, 1),
                    new wjcGrid.CellRange(35, 1, 35, 1),
                    new wjcGrid.CellRange(40, 1, 40, 1),
                    new wjcGrid.CellRange(44, 1, 44, 1),
                    new wjcGrid.CellRange(48, 1, 48, 1),
                    new wjcGrid.CellRange(52, 1, 52, 1),
                    new wjcGrid.CellRange(56, 1, 56, 1),
                    new wjcGrid.CellRange(61, 1, 61, 1),
                    new wjcGrid.CellRange(66, 1, 66, 1),
                    new wjcGrid.CellRange(70, 1, 70, 1),
                    new wjcGrid.CellRange(74, 1, 74, 1)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(6, 1, 6, 1),
                    new wjcGrid.CellRange(6, 3, 6, 3),
                    new wjcGrid.CellRange(10, 1, 11, 1),
                    new wjcGrid.CellRange(15, 1, 15, 1),
                    new wjcGrid.CellRange(15, 3, 15, 3),
                    new wjcGrid.CellRange(19, 1, 19, 1),
                    new wjcGrid.CellRange(19, 3, 19, 3),
                    new wjcGrid.CellRange(23, 1, 24, 1),
                    new wjcGrid.CellRange(28, 1, 28, 1),
                    new wjcGrid.CellRange(28, 3, 28, 3),
                    new wjcGrid.CellRange(32, 1, 33, 1),
                    new wjcGrid.CellRange(37, 1, 38, 1),
                    new wjcGrid.CellRange(42, 1, 42, 1),
                    new wjcGrid.CellRange(42, 3, 42, 3),
                    new wjcGrid.CellRange(46, 1, 46, 1),
                    new wjcGrid.CellRange(46, 3, 46, 3),
                    new wjcGrid.CellRange(50, 1, 50, 1),
                    new wjcGrid.CellRange(50, 3, 50, 3),
                    new wjcGrid.CellRange(54, 1, 54, 1),
                    new wjcGrid.CellRange(54, 3, 54, 3),
                    new wjcGrid.CellRange(58, 1, 59, 1),
                    new wjcGrid.CellRange(63, 1, 64, 1),
                    new wjcGrid.CellRange(68, 1, 68, 1),
                    new wjcGrid.CellRange(68, 3, 68, 3),
                    new wjcGrid.CellRange(72, 1, 72, 1),
                    new wjcGrid.CellRange(72, 3, 72, 3),
                    new wjcGrid.CellRange(76, 1, 76, 1),
                    new wjcGrid.CellRange(76, 3, 76, 3)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(8, 1, 8, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 1, 9, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(10, 2, 10, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(14, 1, 14, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(18, 1, 18, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(22, 1, 22, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(23, 2, 23, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(27, 1, 27, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(31, 1, 31, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(32, 2, 32, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(36, 1, 36, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(37, 2, 37, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(41, 1, 41, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(45, 1, 45, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(49, 1, 49, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(53, 1, 53, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(57, 1, 57, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(58, 2, 58, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(61, 1, 61, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(62, 1, 62, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(63, 2, 63, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(67, 1, 67, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(71, 1, 71, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(75, 1, 75, 3));
        },

        _generateAggregateSheet: function(flexSheet) {
            ...
            flexSheet.setCellData(
                106,
                2,
                'countifs(B12:B21, "Apple", C12:C21, ">10")'
            );
            ...
            flexSheet.setCellData(
                111,
                2,
                "countifs(count_range, field, criteria_range)"
            );
            ...
            flexSheet.setCellData(
                118,
                2,
                "If the sum_range argument is omitted, FlexSheet adds the cells that are specified in the range argument."
            );
            ...
            flexSheet.setCellData(
                127,
                2,
                'sumifs(F12:F21, B12:B21, "Apple", C12:C21, ">10")'
            );
            ...
            flexSheet.setCellData(
                133,
                2,
                "If order is 0 (zero) or omitted, FlexSheet ranks number as if ref were a list sorted in descending order."
            );
            flexSheet.setCellData(
                134,
                2,
                "If order is any nonzero value, FlexSheet ranks number as if ref were a list sorted in ascending order."
            );
            ...
            flexSheet.setCellData(
                150,
                2,
                "The function_num 1-11 or 101-111 that specifies the function to use for the subtotal."
            );
            flexSheet.setCellData(
                151,
                2,
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(29, 1, 29, 1),
                    new wjcGrid.CellRange(36, 1, 36, 1),
                    new wjcGrid.CellRange(43, 1, 43, 1),
                    new wjcGrid.CellRange(50, 1, 50, 1),
                    new wjcGrid.CellRange(57, 1, 57, 1),
                    new wjcGrid.CellRange(64, 1, 64, 1),
                    new wjcGrid.CellRange(71, 1, 71, 1),
                    new wjcGrid.CellRange(78, 1, 78, 1),
                    new wjcGrid.CellRange(85, 1, 85, 1),
                    new wjcGrid.CellRange(90, 1, 90, 2),
                    new wjcGrid.CellRange(95, 1, 95, 1),
                    new wjcGrid.CellRange(103, 1, 103, 1),
                    new wjcGrid.CellRange(109, 1, 109, 1),
                    new wjcGrid.CellRange(115, 1, 115, 1),
                    new wjcGrid.CellRange(124, 1, 124, 1),
                    new wjcGrid.CellRange(130, 1, 130, 1),
                    new wjcGrid.CellRange(140, 1, 140, 1),
                    new wjcGrid.CellRange(147, 1, 147, 1),
                    new wjcGrid.CellRange(152, 2, 153, 6)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(24, 1, 27, 1),
                    new wjcGrid.CellRange(31, 1, 34, 1),
                    new wjcGrid.CellRange(38, 1, 41, 1),
                    new wjcGrid.CellRange(45, 1, 48, 1),
                    new wjcGrid.CellRange(52, 1, 55, 1),
                    new wjcGrid.CellRange(59, 1, 62, 1),
                    new wjcGrid.CellRange(66, 1, 69, 1),
                    new wjcGrid.CellRange(73, 1, 76, 1),
                    new wjcGrid.CellRange(80, 1, 83, 1),
                    new wjcGrid.CellRange(87, 1, 88, 1),
                    new wjcGrid.CellRange(92, 1, 93, 1),
                    new wjcGrid.CellRange(97, 1, 101, 1),
                    new wjcGrid.CellRange(105, 1, 107, 1),
                    new wjcGrid.CellRange(111, 1, 113, 1),
                    new wjcGrid.CellRange(117, 1, 122, 1),
                    new wjcGrid.CellRange(126, 1, 128, 1),
                    new wjcGrid.CellRange(132, 1, 133, 1),
                    new wjcGrid.CellRange(135, 1, 138, 1),
                    new wjcGrid.CellRange(142, 1, 145, 1),
                    new wjcGrid.CellRange(149, 1, 150, 1),
                    new wjcGrid.CellRange(165, 1, 168, 1)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(6, 1, 6, 6),
                    new wjcGrid.CellRange(10, 1, 10, 5)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(1, 1, 4, 7),
                    new wjcGrid.CellRange(11, 5, 20, 5)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(23, 1, 23, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(26, 2, 26, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(30, 1, 30, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(33, 2, 33, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(37, 1, 37, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(40, 2, 40, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(42, 1, 42, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(44, 1, 44, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(47, 2, 47, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(51, 1, 51, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(54, 2, 54, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(58, 1, 58, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(61, 2, 61, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(65, 1, 65, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(68, 2, 68, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(72, 1, 72, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(75, 2, 75, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(79, 1, 79, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(82, 2, 82, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(86, 1, 86, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(90, 1, 90, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(91, 1, 91, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(92, 2, 92, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(96, 1, 96, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(97, 2, 97, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(98, 2, 98, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(100, 2, 100, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(104, 1, 104, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(105, 2, 105, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(106, 2, 106, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(110, 1, 110, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(111, 2, 111, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(112, 2, 112, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(116, 1, 116, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(117, 2, 117, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(118, 2, 118, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(119, 2, 119, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(121, 2, 121, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(125, 1, 125, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(126, 2, 126, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(127, 2, 127, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(131, 1, 131, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(132, 2, 132, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(133, 2, 133, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(134, 2, 134, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(135, 2, 135, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(137, 2, 137, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(141, 1, 141, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(142, 2, 142, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(144, 2, 144, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(148, 1, 148, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(149, 2, 149, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(150, 2, 150, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(151, 2, 151, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(152, 2, 152, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(152, 4, 152, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(153, 2, 153, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(153, 4, 153, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(165, 2, 165, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(167, 2, 167, 3));
        },

        _generateDateSheet: function(flexSheet) {
            ...
            flexSheet.setCellData(
                38,
                1,
                "The unit paratemer can be following values:"
            );
            ...
            flexSheet.setCellData(
                45,
                2,
                'datedif("11/26/2012", "8/15/2015", "Y")'
            );
            flexSheet.setCellData(46, 1, "Result:");
            flexSheet.setCellData(
                46,
            ...
            flexSheet.setCellData(
                47,
                2,
                'datedif("5/26/2015", "11/15/2015", "M")'
            );
            flexSheet.setCellData(48, 1, "Result:");
            flexSheet.setCellData(
                48,
            ...
            flexSheet.setCellData(
                51,
                2,
                'datedif("3/26/2015", "2/15/2016", "MD")'
            );
            ...
            flexSheet.setCellData(
                53,
                2,
                'datedif("11/26/2015", "2/15/2016", "YM")'
            );
            ...
            flexSheet.setCellData(
                55,
                2,
                'datedif("2/26/2016", "2/15/2017", "YD")'
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(30, 1, 30, 1),
                    new wjcGrid.CellRange(35, 1, 35, 1),
                    new wjcGrid.CellRange(39, 1, 44, 1)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(18, 1, 18, 1),
                    new wjcGrid.CellRange(18, 3, 18, 3),
                    new wjcGrid.CellRange(22, 1, 23, 1),
                    new wjcGrid.CellRange(27, 1, 28, 1),
                    new wjcGrid.CellRange(32, 1, 33, 1),
                    new wjcGrid.CellRange(32, 3, 33, 3),
                    new wjcGrid.CellRange(37, 1, 37, 1),
                    new wjcGrid.CellRange(39, 1, 56, 1)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(2, 4, 2, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 1, 9, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(13, 1, 13, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(17, 1, 17, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(21, 1, 21, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(22, 2, 22, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(26, 1, 26, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(27, 2, 27, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(31, 1, 31, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(36, 1, 36, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(37, 2, 37, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(38, 1, 38, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(39, 2, 39, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(40, 2, 40, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(41, 2, 41, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(42, 2, 42, 8));
            flexSheet.mergeRange(new wjcGrid.CellRange(43, 2, 43, 8));
            flexSheet.mergeRange(new wjcGrid.CellRange(44, 2, 44, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(45, 2, 45, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(47, 2, 47, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(49, 2, 49, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(51, 2, 51, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(53, 2, 53, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(55, 2, 55, 4));
        },

        _generateLookupReferenceSheet: function(flexSheet) {
            flexSheet.setCellData(0, 1, "1. Cell Reference");
            flexSheet.setCellData(
                1,
                1,
                "Gets value for a specific cell in the flexsheet."
            );
            flexSheet.setCellData(2, 1, "Sample:");
            ...
            flexSheet.setCellData(
                28,
                2,
                "If row_num or column_num to 0, inedx returns the array of values for the entire column or row."
            );
            flexSheet.setCellData(29, 1, "Sample:");
            ...
            flexSheet.setCellData(
                36,
                2,
                "hlookup(lookup_value, range, row_index_num, [range_lookup])"
            );
            flexSheet.setCellData(37, 1, "Remarks:");
            flexSheet.setCellData(
                37,
                2,
                "range_lookup is a logical value that specifies whether you want HLOOKUP to find an exact match "
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(0, 1, 0, 1),
                    new wjcGrid.CellRange(4, 1, 4, 1),
                    new wjcGrid.CellRange(9, 1, 9, 1),
                    new wjcGrid.CellRange(13, 1, 13, 1),
                    new wjcGrid.CellRange(17, 1, 17, 1),
                    new wjcGrid.CellRange(21, 1, 21, 1),
                    new wjcGrid.CellRange(25, 1, 25, 1),
                    new wjcGrid.CellRange(34, 1, 34, 1),
                    new wjcGrid.CellRange(45, 1, 45, 5)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    ...
                    new wjcGrid.CellRange(2, 3, 2, 3),
                    new wjcGrid.CellRange(6, 1, 7, 1),
                    new wjcGrid.CellRange(11, 1, 11, 1),
                    new wjcGrid.CellRange(11, 3, 11, 3),
                    new wjcGrid.CellRange(15, 1, 15, 1),
                    new wjcGrid.CellRange(15, 3, 15, 3),
                    new wjcGrid.CellRange(19, 1, 19, 1),
                    new wjcGrid.CellRange(19, 3, 19, 3),
                    new wjcGrid.CellRange(23, 1, 23, 1),
                    new wjcGrid.CellRange(23, 3, 23, 3),
                    new wjcGrid.CellRange(27, 1, 32, 1),
                    new wjcGrid.CellRange(36, 1, 37, 1),
                    new wjcGrid.CellRange(48, 1, 51, 1)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(0, 1, 0, 2));
            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(2, 4, 2, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 1, 5, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(6, 2, 6, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(10, 1, 10, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(14, 1, 14, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(18, 1, 18, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(22, 1, 22, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(26, 1, 26, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(27, 2, 27, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(28, 2, 28, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(29, 2, 29, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(31, 2, 31, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(35, 1, 35, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(36, 2, 36, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(37, 2, 37, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(38, 2, 38, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(39, 2, 39, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(40, 2, 40, 8));
            flexSheet.mergeRange(new wjcGrid.CellRange(41, 2, 41, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(42, 2, 42, 7));
            flexSheet.mergeRange(new wjcGrid.CellRange(43, 2, 43, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(48, 2, 48, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(50, 2, 50, 4));
        },

        _generateFinancialSheet: function(flexSheet) {
            ...
            flexSheet.setCellData(
                9,
                2,
                "0 or omitted means at the end of the period."
            );
            flexSheet.setCellData(
                10,
                2,
                "1 means at the beginning of the period."
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(0, 1, 0, 1),
                    new wjcGrid.CellRange(4, 1, 11, 1)
                ]
            );
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(2, 1, 2, 1),
                    new wjcGrid.CellRange(4, 1, 13, 1)
                ]
            );

            flexSheet.mergeRange(new wjcGrid.CellRange(1, 1, 1, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(2, 2, 2, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(3, 1, 3, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(4, 2, 4, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(5, 2, 5, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(6, 2, 6, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(7, 2, 7, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(8, 2, 8, 5));
            flexSheet.mergeRange(new wjcGrid.CellRange(9, 2, 9, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(10, 2, 10, 4));
            flexSheet.mergeRange(new wjcGrid.CellRange(11, 2, 11, 6));
            flexSheet.mergeRange(new wjcGrid.CellRange(12, 2, 12, 3));
        },

        _generateSummraySheet: function(flexSheet) {
            ...
            flexSheet.applyCellsStyle(
                ...
                [
                    new wjcGrid.CellRange(1, 0, 1, 3),
                    new wjcGrid.CellRange(11, 0, 11, 3)
                ]
            );
            flexSheet.applyCellsStyle(
                {
                ...
                [new wjcGrid.CellRange(2, 3, 11, 3)]
            );
            for (var rowIndex = 3; rowIndex < 11; rowIndex++) {
                if (rowIndex % 2 === 1) {
                    flexSheet.applyCellsStyle(
                        ...
                        [new wjcGrid.CellRange(rowIndex, 0, rowIndex, 3)]
                    );
                }
            }

            flexSheet.mergeRange(new wjcGrid.CellRange(1, 2, 1, 3));
            flexSheet.mergeRange(new wjcGrid.CellRange(8, 0, 8, 1));
        }
    }
});
