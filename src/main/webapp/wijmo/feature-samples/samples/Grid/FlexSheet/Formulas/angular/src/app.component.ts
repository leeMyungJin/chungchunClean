...
export class AppComponent {
    ...
    initializeFlexSheet(flex: wjcSheet.FlexSheet) {
        ...
        flex.selectionChanged.addHandler((sender: any, args: wjcGrid.CellRangeEventArgs) => {
            ...
            if (selection.isValid) {
                this.currentCellData = flex.getCellData(selection.row, selection.col, true);
            }
        });
    }

    private _generateBasicOperatorsSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            textAlign: 'right'
        }, [new wjcGrid.CellRange(2, 1, 2, 1), new wjcGrid.CellRange(2, 3, 2, 3),
            new wjcGrid.CellRange(6, 1, 7, 1), new wjcGrid.CellRange(6, 3, 7, 3),
            new wjcGrid.CellRange(11, 1, 12, 1), new wjcGrid.CellRange(11, 3, 12, 3),
            new wjcGrid.CellRange(16, 1, 16, 1), new wjcGrid.CellRange(16, 3, 16, 3),
            new wjcGrid.CellRange(20, 1, 21, 1),
            new wjcGrid.CellRange(25, 1, 25, 1), new wjcGrid.CellRange(25, 3, 25, 3),
            new wjcGrid.CellRange(29, 1, 29, 1), new wjcGrid.CellRange(29, 3, 29, 3),
            new wjcGrid.CellRange(33, 1, 33, 1), new wjcGrid.CellRange(33, 3, 33, 3)]);
    ...
    private _generateMathSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            ...
            new wjcGrid.CellRange(6, 1, 6, 1), new wjcGrid.CellRange(6, 3, 6, 3),
            new wjcGrid.CellRange(10, 1, 10, 1), new wjcGrid.CellRange(10, 3, 10, 3),
            new wjcGrid.CellRange(14, 1, 14, 1), new wjcGrid.CellRange(14, 3, 14, 3),
            new wjcGrid.CellRange(18, 1, 18, 1), new wjcGrid.CellRange(18, 3, 18, 3),
            ...
            new wjcGrid.CellRange(34, 1, 34, 1), new wjcGrid.CellRange(34, 3, 34, 3),
            new wjcGrid.CellRange(38, 1, 38, 1), new wjcGrid.CellRange(38, 3, 38, 3),
            new wjcGrid.CellRange(42, 1, 42, 1), new wjcGrid.CellRange(42, 3, 42, 3),
            new wjcGrid.CellRange(46, 1, 47, 1), new wjcGrid.CellRange(46, 3, 47, 3),
            new wjcGrid.CellRange(50, 1, 51, 1), new wjcGrid.CellRange(50, 3, 51, 3),
            ...
            new wjcGrid.CellRange(85, 1, 85, 1), new wjcGrid.CellRange(85, 3, 85, 3)]);
    ...
    private _generateLogicalSheet(flexSheet: wjcSheet.FlexSheet) {
    ...
    private _generateTextSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            ...
            new wjcGrid.CellRange(15, 1, 15, 1), new wjcGrid.CellRange(15, 3, 15, 3),
            new wjcGrid.CellRange(19, 1, 19, 1), new wjcGrid.CellRange(19, 3, 19, 3),
            new wjcGrid.CellRange(23, 1, 24, 1),
            new wjcGrid.CellRange(28, 1, 28, 1), new wjcGrid.CellRange(28, 3, 28, 3),
            new wjcGrid.CellRange(32, 1, 33, 1),
            new wjcGrid.CellRange(37, 1, 38, 1),
            new wjcGrid.CellRange(42, 1, 42, 1), new wjcGrid.CellRange(42, 3, 42, 3),
            new wjcGrid.CellRange(46, 1, 46, 1), new wjcGrid.CellRange(46, 3, 46, 3),
            new wjcGrid.CellRange(50, 1, 50, 1), new wjcGrid.CellRange(50, 3, 50, 3),
            new wjcGrid.CellRange(54, 1, 54, 1), new wjcGrid.CellRange(54, 3, 54, 3),
            new wjcGrid.CellRange(58, 1, 59, 1),
            new wjcGrid.CellRange(63, 1, 64, 1),
            new wjcGrid.CellRange(68, 1, 68, 1), new wjcGrid.CellRange(68, 3, 68, 3),
            new wjcGrid.CellRange(72, 1, 72, 1), new wjcGrid.CellRange(72, 3, 72, 3),
            new wjcGrid.CellRange(76, 1, 76, 1), new wjcGrid.CellRange(76, 3, 76, 3)]);
    ...
    private _generateAggregateSheet(flexSheet: wjcSheet.FlexSheet) {
        let rowIndex: number,
            colIndex: number;
        ...
        flexSheet.applyCellsStyle({
            ...
            new wjcGrid.CellRange(132, 1, 133, 1), new wjcGrid.CellRange(135, 1, 138, 1),
            new wjcGrid.CellRange(142, 1, 145, 1),
            new wjcGrid.CellRange(149, 1, 150, 1), new wjcGrid.CellRange(165, 1, 168, 1)]);
    ...
    private _generateDateSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            ...
            new wjcGrid.CellRange(32, 1, 33, 1), new wjcGrid.CellRange(32, 3, 33, 3),
    ...
    private _generateLookupReferenceSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            ...
            new wjcGrid.CellRange(11, 1, 11, 1), new wjcGrid.CellRange(11, 3, 11, 3),
            new wjcGrid.CellRange(15, 1, 15, 1), new wjcGrid.CellRange(15, 3, 15, 3),
            new wjcGrid.CellRange(19, 1, 19, 1), new wjcGrid.CellRange(19, 3, 19, 3),
            new wjcGrid.CellRange(23, 1, 23, 1), new wjcGrid.CellRange(23, 3, 23, 3),
    ...
    private _generateFinancialSheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        flexSheet.applyCellsStyle({
            textAlign: 'right'
        }, [new wjcGrid.CellRange(2, 1, 2, 1), new wjcGrid.CellRange(4, 1, 13, 1)]);
    ...
    private _generateSummraySheet(flexSheet: wjcSheet.FlexSheet) {
        ...
        }, [new wjcGrid.CellRange(1, 0, 1, 3), new wjcGrid.CellRange(11, 0, 11, 3)]);
        flexSheet.applyCellsStyle({
            textAlign: 'right'
