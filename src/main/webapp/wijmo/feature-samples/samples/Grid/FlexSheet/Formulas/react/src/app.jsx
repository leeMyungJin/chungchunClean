...
class App extends React.Component {
    ...
    render() {
        return (<div className="container-fluid">
                <wjGridSheet.FlexSheet initialized={this.initializeFlexSheet.bind(this)}>
                    <wjGridSheet.Sheet name="Basic Operators" rowCount={35} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Math" rowCount={90} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Logical" rowCount={30} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Text" rowCount={80} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Aggregate" rowCount={170} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Date" rowCount={60} columnCount={9}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Lookup & Reference" rowCount={55} columnCount={10}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Financial" rowCount={20} columnCount={8}></wjGridSheet.Sheet>
                    <wjGridSheet.Sheet name="Summary" rowCount={20} columnCount={8}></wjGridSheet.Sheet>
                </wjGridSheet.FlexSheet>
                <p>
                    <b>Cell Content:</b>
                    {this.state.currentCellData}
                </p>
            </div>);
    }
    initializeFlexSheet(flex) {
        ...
        flex.selectionChanged.addHandler((sender, args) => {
            ...
            if (selection.isValid) {
                this.setState({
                    currentCellData: flex.getCellData(selection.row, selection.col, true)
                });
            }
        });
    }
    ...
    _generateLogicalSheet(flexSheet) {
    ...
    _generateAggregateSheet(flexSheet) {
    ...
    _generateLookupReferenceSheet(flexSheet) {
    ...
    _generateFinancialSheet(flexSheet) {
    ...
    _generateSummraySheet(flexSheet) {
