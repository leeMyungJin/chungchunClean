...
function init() {
    ...
    formulaSheet.addUnboundSheet('Basic Operators', 35, 8);
    formulaSheet.addUnboundSheet('Math', 90, 8);
    formulaSheet.addUnboundSheet('Logical', 30, 8);
    formulaSheet.addUnboundSheet('Text', 80, 8);
    formulaSheet.addUnboundSheet('Aggregate', 170, 8);
    formulaSheet.addUnboundSheet('Date', 60, 9);
    formulaSheet.addUnboundSheet('Lookup & Reference', 55, 10);
    formulaSheet.addUnboundSheet('Financial', 20, 8);
    formulaSheet.addUnboundSheet('Summary', 20, 8);
