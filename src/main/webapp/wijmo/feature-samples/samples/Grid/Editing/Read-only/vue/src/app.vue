<template>
    <div class="container-fluid">
        <wj-flex-grid
            ...
            <wj-flex-grid-column binding="country" header="Country" :isRequired=true />
            <wj-flex-grid-column binding="sales" header="Sales" :isRequired=false />
            <wj-flex-grid-column binding="expenses" header="Expenses" :isRequired=false />
