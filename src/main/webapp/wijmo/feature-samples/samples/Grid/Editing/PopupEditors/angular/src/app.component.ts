...
export class AppComponent {
    ...
    @ViewChild('cboCountry', { static: true }) cboCountry: wjcInput.ComboBox;
    @ViewChild('numberSales', { static: true }) numberSales: wjcInput.InputNumber;
    @ViewChild('numberExpenses', { static: true }) numberExpenses: wjcInput.InputNumber;
