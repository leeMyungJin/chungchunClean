<template>
    <div class="container-fluid">
        ...
        <label class="normal-weight">Update Interval (ms)
            <wj-combo-box :itemsSource="intervalItems" :selectedValue="interval" :textChanged="intervalItemsChange" />
        </label>
        <label class="normal-weight">Batch Size (# items)
            <wj-combo-box :itemsSource="batchSizeItems" :selectedValue="batchSize" :textChanged="batchSizeItemsChange" />
        </label>
        <wj-flex-grid
            :isReadOnly="true"
            :selectionMode="'Row'"
            ...
            <wj-flex-grid-column binding="bid" header="Bid" :width="200" format="n2" />
            <wj-flex-grid-column binding="ask" header="Ask" :width="200" format="n2" />
            <wj-flex-grid-column binding="lastSale" header="Last Sale" :width="200" format="n2" />
            <wj-flex-grid-column binding="bidSize" header="Bid Size" format="n0" />
            <wj-flex-grid-column binding="askSize" header="Ask Size" format="n0" />
            <wj-flex-grid-column binding="lastSize" header="Last Size" format="n0" />
            <wj-flex-grid-column binding="volume" header="Volume" format="n0" />
            <wj-flex-grid-column binding="quoteTime" header="Quote Time" format="hh:mm:ss" align="center" />
            <wj-flex-grid-column binding="tradeTime" header="Trade Time" format="hh:mm:ss" align="center" />
        </wj-flex-grid>
    </div>
</template>
