...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <label>
                Batch Size (# items)
                <wjInput.ComboBox itemsSource={this.batchSizeItems} selectedValue={this.state.batchSize} textChanged={this.batchSizeItemsChange}/>
            </label>
            <FlexGrid isReadOnly={true} selectionMode="Row" initialized={this.initializeGrid} itemsSource={this.state.data}>
                ...
                <FlexGridColumn binding="bid" header="Bid" width={200} format="n2"/>
                <FlexGridColumn binding="ask" header="Ask" width={200} format="n2"/>
                <FlexGridColumn binding="lastSale" header="Last Sale" width={200} format="n2"/>
                <FlexGridColumn binding="bidSize" header="Bid Size" format="n0"/>
                <FlexGridColumn binding="askSize" header="Ask Size" format="n0"/>
                <FlexGridColumn binding="lastSize" header="Last Size" format="n0"/>
                <FlexGridColumn binding="volume" header="Volume" format="n0"/>
                <FlexGridColumn binding="quoteTime" header="Quote Time" format="hh:mm:ss" align="center"/>
                <FlexGridColumn binding="tradeTime" header="Trade Time" format="hh:mm:ss" align="center"/>
            </FlexGrid>
        </div>;
    }
    initializeGrid(flex) {
    ...
    _formatDynamicCell(cell, item, col, history, flare) {
        ...
        let html = '<div class="ticker chg-{dir} flare-{fdir}"> ' +
            ...
            '</div>';
        // value
        html = html.replace('{value}', Globalize.format(item[col.binding], col.format));
        // % change
