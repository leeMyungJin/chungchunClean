    ...
    render() {
        return <div className="container-fluid">
			...
			<wjGrid.FlexGrid itemsSource={this.state.data} autoClipboard={false}>
				...
				<wjGrid.FlexGridColumn header="Product" binding="product" width="*" minWidth={100} allowResizing={false}>
				</wjGrid.FlexGridColumn>
				<wjGrid.FlexGridColumn header="Revenue" binding="amount" format="n0" width={120}>
				</wjGrid.FlexGridColumn>
			</wjGrid.FlexGrid>
			...
			<wjGrid.FlexGrid itemsSource={this.state.data} autoClipboard={false} allowResizing="None">
				<wjGrid.FlexGridColumn header="Date" binding="start" width="*">
				</wjGrid.FlexGridColumn>
				<wjGrid.FlexGridColumn header="Product" binding="product" width="*" minWidth={100}>
				</wjGrid.FlexGridColumn>
				<wjGrid.FlexGridColumn header="Revenue" binding="amount" format="n0" width="*">
				</wjGrid.FlexGridColumn>
				<wjGrid.FlexGridColumn header="Expense" binding="amount2" format="n0" width="*">
				</wjGrid.FlexGridColumn>
			</wjGrid.FlexGrid>
		</div>;
    }
