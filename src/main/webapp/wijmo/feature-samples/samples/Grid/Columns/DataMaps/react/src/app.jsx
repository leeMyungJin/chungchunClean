    ...
    render() {
        return <div className="container-fluid">
            <wjGrid.FlexGrid initialized={this.mainGridInitialized.bind(this)} itemsSource={this.state.data}>
                <wjGrid.FlexGridColumn header="Customer" binding="customer" width="1.5*" dataMap={this.state.customerMap}>
                </wjGrid.FlexGridColumn>
                <wjGrid.FlexGridColumn header="Country" binding="country" width="*" dataMap={this.state.countries}>
                </wjGrid.FlexGridColumn>
                <wjGrid.FlexGridColumn header="Downloads" binding="downloads" width="*" format="n0">
                </wjGrid.FlexGridColumn>
                <wjGrid.FlexGridColumn header="Sales" binding="sales" width="*" format="n0">
                </wjGrid.FlexGridColumn>
                <wjGrid.FlexGridColumn header="Expenses" binding="expenses" width="*" format="n0">
                </wjGrid.FlexGridColumn>
            </wjGrid.FlexGrid>
