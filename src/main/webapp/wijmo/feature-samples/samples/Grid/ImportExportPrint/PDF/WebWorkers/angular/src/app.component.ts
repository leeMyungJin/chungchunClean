...
export class AppComponent implements OnDestroy {
    ...
    //
    //
    @ViewChild('flexGrid2', { static: true }) flexGrid2: grid.FlexGrid;
    @ViewChild('flexPie', { static: true }) flexPie: chart.FlexPie;
    ctx2: IContext = {
        exporting: false,
        progress: 0,
        preparing: false,
    ...
    //
    //
    @ViewChild('flexGrid3', { static: true }) flexGrid3: grid.FlexGrid;
    ctx3: IContext = {
        exporting: false,
        progress: 0,
        preparing: false,
