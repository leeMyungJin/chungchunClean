...
class App extends React.Component {
    render() {
        return <div className="container-fluid">
            ...
            <div id="flexGrid" className="grid"></div>
            <div id="flexGridFooter" className="gridFooter"></div>
        </div>;
    }
    exportPDF() {
    ...
    drawEmployee(doc, employee) {
        ...
        try {
            ...
            doc.drawText(wjcCore.changeType(tot.total - employee.advance, wjcCore.DataType.String, 'c'));
            //
            ...
            doc.drawText(wjcCore.changeType(tot.total, wjcCore.DataType.String, 'c'));
            doc.moveDown(2);
            //
