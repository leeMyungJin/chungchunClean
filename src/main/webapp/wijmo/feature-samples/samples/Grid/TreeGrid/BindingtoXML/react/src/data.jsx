...
export function getProductsByCategory() {
    let items = [], parser = new DOMParser(), xml = getXml(), doc = parser.parseFromString(xml, 'application/xml');
    // get categories
    let categories = doc.querySelectorAll('category');
    for (let c = 0; c < categories.length; c++) {
        ...
        let products = category.querySelectorAll('product');
