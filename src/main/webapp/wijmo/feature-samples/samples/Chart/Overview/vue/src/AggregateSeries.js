...
var wjcCore = require("@grapecity/wijmo");
var wjcChart = require("@grapecity/wijmo.chart");
    ...
    Object.defineProperty(AggregateSeries.prototype, "autoGroupIntervals", {
        ...
        set: function (value) {
            ...
            if (this._autoGroupIntervals !== value) {
                ...
                value.forEach(function (val) { return wjcCore.assert(_this._isValidInterval(wjcCore.asString(val, false)), "Invalid autoGroupIntervals"); }, this);
...
exports.AggregateSeries = AggregateSeries;
