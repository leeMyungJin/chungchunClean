...
export class AppComponent implements AfterViewInit {
    ...
    constructor(@Inject(DataService) private dataService: DataService) {
        ...
        this.palette = ['rgba(3,62,118,1)', 'rgba(135,192,72,1)', 'rgba(89,130,44,1)'];
    }
    //
    ngAfterViewInit() {
        ...
        theChart.axisX.min = this.data[0].date;
        theChart.axisX.max = this.data[this.data.length - 1].date;
        theChart.endUpdate();
    }
    //
