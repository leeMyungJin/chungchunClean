<template>
    <div class="container-fluid">
        <wj-flex-chart :itemsSource="data" bindingX="year" chartType="Area" stacking="Stacked100pc" :palette="palette">
            <wj-flex-chart-axis wjProperty="axisY" title="Populations"></wj-flex-chart-axis>
