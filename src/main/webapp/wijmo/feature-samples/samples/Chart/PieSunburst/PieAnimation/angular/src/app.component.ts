...
import './styles.css';
//
import { isArray, ObservableArray } from '@grapecity/wijmo';
...
export class AppComponent {
    @ViewChild('pieAnimation', { static: true }) pieAnimation: ChartAnimation;
    ...
    set innerRadius(value: number) {
        if (this._innerRadius !== value && value >= 0 && value<=1) {
            this.pieChart.innerRadius = this._innerRadius = value;
        }
    }
    //
    resetData() {
