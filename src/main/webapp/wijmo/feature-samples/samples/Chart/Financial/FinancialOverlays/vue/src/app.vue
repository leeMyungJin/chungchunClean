<template>
    <div class="container-fluid">
                ...
                <div id="settingsBody" class="panel-collapse collapse in">
                    <div class="panel-body">
                        ...
                        <ul class="list-inline" v-show="selectedOverlay === 'envelopes'">
                            ...
                            <li>
                                <wj-menu :header="'Type'" :value="properties.envelopeType" 
                                    :itemClicked="typeChanged">
        ...
        <!-- overlays Chart -->
        <wj-financial-chart :itemsSource="data" bindingX="date" :tooltipContent="tooltip" chartType="Candlestick" >
