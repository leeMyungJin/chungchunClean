...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
            ...
            <wjFinance.FinancialChart itemsSource={this.state.data} bindingX="date" chartType="HeikinAshi" tooltipContent="tooltip" initialized={this.initializeChart.bind(this)}>
