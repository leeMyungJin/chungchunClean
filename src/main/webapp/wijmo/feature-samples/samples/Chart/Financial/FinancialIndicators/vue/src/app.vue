<template>
    <div class="container-fluid">
        ...
        <!-- FinancialChart -->
        <wj-financial-chart :itemsSource="data" bindingX="date" :tooltipContent="tooltip" :initialized="initializeChart">
        ...
        <!-- Indicators Chart -->
        <wj-financial-chart :itemsSource="data" style="height: 200px" bindingX="date"  
