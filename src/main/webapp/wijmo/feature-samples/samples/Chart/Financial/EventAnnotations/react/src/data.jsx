...
export function getData() {
    ...
    for (var i = 0; i < data.length; i++) {
        let item = {
            date: core.Globalize.parseDate(data[i].date, 'MM/dd/yy'),
            open: data[i].open,
            high: data[i].high,
            low: data[i].low,
            close: data[i].close,
    ...
    let data = [
        {
            ...
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2014-11-26", 'yyyy-MM-dd'), "y": 70 },
        ...
        },
        {
            ...
            "attachment": 1,
            "position": 0,
            "start": { "x": core.Globalize.parseDate("2014-05-08", 'yyyy-MM-dd'), "y": 64 },
            "end": { "x": core.Globalize.parseDate("2014-09-08", 'yyyy-MM-dd'), "y": 84 },
        ...
        },
        {
            ...
            "attachment": 1,
            "position": 0,
            "start": { "x": core.Globalize.parseDate("2014-05-08", 'yyyy-MM-dd'), "y": 56 },
            "end": { "x": core.Globalize.parseDate("2014-09-08", 'yyyy-MM-dd'), "y": 76 },
            "style": { "fill": "#FF0040", "stroke": "#3ADF00", "fill-opacity": 2, "stroke-width": 1, "stroke-opacity": 0.5 }
        },
        {
            "name": "eventa",
        ...
        },
        {
            ...
            "start": { "x": core.Globalize.parseDate("2014-4-10", 'yyyy-MM-dd'), "y": 59.16 },
            "end": { "x": core.Globalize.parseDate("2016-4-10", 'yyyy-MM-dd'), "y": 59.16 },
        ...
        },
        {
            ...
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2015-3-2", 'yyyy-MM-dd'), "y": 80 }
        },
        {
            "name": "newsaMarker",
            "type": "Image",
        ...
        },
        {
            ...
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2014-7-8", 'yyyy-MM-dd'), "y": 62 }
        },
        {
            "name": "newsbMarker",
            "type": "Image",
        ...
        },
        {
            ...
            "text": "Rising wedge",
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2014-5-8", 'yyyy-MM-dd'), "y": 64 },
        ...
        },
        {
            ...
            "tooltip": "Bid: $73.59",
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2014-10-14", 'yyyy-MM-dd'), "y": 73 },
        ...
        },
        {
            ...
            "tooltip": "Offer: $77.74",
            "attachment": 1,
            "point": { "x": core.Globalize.parseDate("2015-1-8", 'yyyy-MM-dd'), "y": 78 },
