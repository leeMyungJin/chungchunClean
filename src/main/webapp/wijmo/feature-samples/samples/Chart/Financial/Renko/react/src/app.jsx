...
class App extends React.Component {
    ...
    render() {
        return <div className="container-fluid">
                        ...
                        <div className="panel-body">
                            <ul className="list-inline">
                                <li>
                                    ...
                                    <wjInput.InputNumber initialized={this.initializeInput.bind(this)} value={this.state.options.renko.boxSize} min={0} step={1} format="n0" valueChanged={this.boxSizeChanged.bind(this)}>
                                    </wjInput.InputNumber>
                                </li>
                                <li>
                                    <wjInput.Menu header="Range Mode" value={this.state.options.renko.rangeMode} itemClicked={this.rangeModeChanged.bind(this)}>
                                        <wjInput.MenuItem value="Fixed">Fixed</wjInput.MenuItem>
                                        <wjInput.MenuItem value="ATR">Average True Range</wjInput.MenuItem>
                                    </wjInput.Menu>
                                </li>
                                <li>
                                    <wjInput.Menu header="Data Fields" value={this.state.options.renko.fields} itemClicked={this.fieldsChanged.bind(this)}>
            ...
            <wjFinance.FinancialChart initialized={this.initializeChart.bind(this)} itemsSource={this.state.data} bindingX="date" chartType="Renko" options={this.state.options} tooltipContent="tooltip">
