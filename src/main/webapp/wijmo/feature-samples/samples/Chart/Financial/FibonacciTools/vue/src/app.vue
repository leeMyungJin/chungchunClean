                    ...
                    <div class="panel-body">
                        ...
                        <ul class="list-inline" v-show="selectedFib === 'arcs'">
                            <li>
                                <label>Start X</label>
                                <wj-input-number
                                    :value="properties.arcs.start.x"
                                    :step="1"
                                    :valueChanged="asxChanged">
                                </wj-input-number>
                            </li>
                            <li>
                                <label>Start Y</label>
                                <wj-input-number
                                    :value="properties.arcs.start.y"
                                    :step="1"
                                    :valueChanged="asyChanged">
                                </wj-input-number>
                            </li>
                        </ul>
                        <ul class="list-inline" v-show="selectedFib === 'arcs'">
                            <li>
                                <label>End X</label>
                                <wj-input-number
                                    :value="properties.arcs.end.x"
                                    :step="1"
                                    :valueChanged="aexChanged">
                                </wj-input-number>
                            </li>
                            <li>
                                <label>End Y</label>
                                <wj-input-number
                                    :value="properties.arcs.end.y"
                                    :step="1"
                                    :valueChanged="aeyChanged">
                                </wj-input-number>
                            </li>
                        </ul>
                        ...
                        <ul class="list-inline" v-show="selectedFib === 'fans'">
                            <li>
                                <label>Start X</label>
                                <wj-input-number
                                    :value="properties.fans.start.x"
                                    :step="1"
                                    :valueChanged="fsxChanged">
                                </wj-input-number>
                            </li>
                            <li>
                                <label>Start Y</label>
                                <wj-input-number
                                    :value="properties.fans.start.y"
                                    :step="1"
                                    :valueChanged="fsyChanged">
                                </wj-input-number>
                            </li>
                        </ul>
                        <ul class="list-inline" v-show="selectedFib === 'fans'">
                            <li>
                                <label>End X</label>
                                <wj-input-number
                                    :value="properties.fans.end.x"
                                    :step="1"
                                    :valueChanged="fexChanged">
                                </wj-input-number>
                            </li>
                            <li>
                                <label>End Y</label>
                                <wj-input-number
                                    :value="properties.fans.end.y"
                                    :step="1"
                                    :valueChanged="feyChanged">
                                </wj-input-number>
                            </li>
                        </ul>
                        ...
                        <ul class="list-inline" v-show="selectedFib === 'timeZones'">
                            <li>
                                <label>Start X</label>
                                <wj-input-number
                                    :value="properties.timeZones.start"
                                    :step="1"
                                    :valueChanged="tsxChanged">
                                </wj-input-number>
                            </li>
                            <li>
                                <label>End X</label>
                                <wj-input-number
                                    :value="properties.timeZones.end"
                                    :step="1"
                                    :valueChanged="texChanged">
                                </wj-input-number>
                            </li>
                        </ul>
                    </div>
        ...
        methods: {
            ...
            typeClick: function(menu) {
                if(menu.selectedItem != null) {
                    this.selectedFib = menu.selectedItem.value;
                }
            },
            uptrendChanged: function(menu) {
                if(menu.selectedItem != null) {
                    this.properties.retracements.uptrend = menu.selectedItem.value;
                    this.uptrend = menu.selectedItem.value;
                }
            },
