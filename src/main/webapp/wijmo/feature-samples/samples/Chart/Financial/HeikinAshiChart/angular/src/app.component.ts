...
export class AppComponent {
    ...
    @ViewChild('theChart', { static: true }) theChart: wjChartFinance.FinancialChart;
    @ViewChild('selectorChart', { static: true }) selectorChart: wjChartFinance.FinancialChart;
    @ViewChild('selector', { static: true }) selector: wjChartInteraction.RangeSelector;
    //
