...
export class AppComponent implements AfterViewInit {
    ...
    @ViewChild('chart1', { static: true }) chart1: wjcChart.FlexChart;
    @ViewChild('chart2', { static: true }) chart2: wjcChart.FlexChart;
    @ViewChild('chart3', { static: true }) chart3: wjcChart.FlexChart;
    @ViewChild('selector', { static: true }) selector: wjcChartInteraction.RangeSelector;
    //
