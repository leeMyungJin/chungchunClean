...
export class AppComponent {
    ...
    cbData: string[];
    order: number;
    eqEle: HTMLDivElement;
    @ViewChild('orderIpt', { static: true }) orderIpt: wjInput.InputNumber;
    @ViewChild('trendline', { static: true }) trendLine: wjChartAnalytics.TrendLine;
    //
    ...
    showEquation() {
        if(!this.eqEle){
            this.eqEle = <HTMLDivElement>document.getElementById('equation');
        }
    ...
    //
    valueChanged(s: wjInput.InputNumber) {
