    ...
    <div class="container-fluid">
        <div class="yearpicker">
            <wj-linear-gauge
                ...
                :initialized="onGaugeInitialized">
                <wj-range wjProperty="pointer" :thickness=0.08 />
                <wj-range wjProperty="face" :thickness=0.08 />
            </wj-linear-gauge>
        ...
        <wj-flex-chart
            ...
            selectionMode="Point"
            v-bind:class="[data.currentItem? 'tracking-country' : '', 'wj-control', 'wj-flexchart']"
